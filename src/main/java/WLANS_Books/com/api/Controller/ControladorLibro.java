...
//Se crea controlador metodo Get que trae todos los libros
    ...
    @GetMapping
    @RequestMapping(value = "ConsultarLibro",method = RequestMethod.GET)
    ...
    @GetMapping
    @RequestMapping(value = "BuscarLibro/{id}",method = RequestMethod.GET)
    ...
    @DeleteMapping
    @RequestMapping(value = "EliminarLibro/{id}",method = RequestMethod.DELETE)
